...
object TimingScenarios {
    ...
    val CANONICAL: List<Case> = listOf(
        ...
        Case(
            "sentence end after three words: 1 + 2.0 * 0.3 = 1.6x",
            word(boundary = Boundary.SENTENCE, span = 3),
            STEADY,
            RUNNING,
            384,
        ),
        Case(
            "sentence end after ten words earns the full 3.0x",
            word(boundary = Boundary.SENTENCE, span = 10),
            STEADY,
            RUNNING,
            720,
        ),
