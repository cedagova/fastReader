...
| OUT501 | OUTCOME | ROOT | Account library on the shelf, kept in step, removable with Undo | https://github.com/cedagova/fastReader/issues/106 |
| OUT502 | OUTCOME | ROOT | Add a device book to the account through publication import | https://github.com/cedagova/fastReader/issues/107 |
| OUT503 | OUTCOME | ROOT | Read an account book on this device from a verified downloaded copy | https://github.com/cedagova/fastReader/issues/108 |
| OUT504 | OUTCOME | ROOT | Reading position portable between FastReader and reader-web | https://github.com/cedagova/fastReader/issues/109 |
| OUT505 | OUTCOME | ROOT | Chunipers alignment proposals filed and linked | https://github.com/cedagova/fastReader/issues/110 |
